...
active_context:
  ...
  blocked_by: ""
  next_step:
    - Implement ERPService.cs để lấy OAuth2 token và POST data lên Dynamics 365 sau khi quét QR thành công
  last_session: "2026-05-25"
  open_questions:
    - "Dynamics 365: entity name (table) để log vào là gì? (ví dụ: cut_sheetlogs)"
    - "Các field cần log: QR1 code, QR2 code, station, timestamp, result (pass/fail)?"
```
